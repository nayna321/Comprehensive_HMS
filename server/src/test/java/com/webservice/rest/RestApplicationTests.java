...
public class RestApplicationTests 
{
    ...
    public void  showPatientInformationTest(){
        ...
        assertEquals(patient.getName(),"Sayan Kundu");
    }

    @Test
    public void showDoctorInformationTest(){
        Doctor doc = doctorController.getDoctorInfo("Nayna Guha"); 
    ...
    public void savePatientInformation(){
        Patient patient = new Patient(1001, "hello", 30, "Nayna Guha",LocalDate.now(), "male", "xyz");
